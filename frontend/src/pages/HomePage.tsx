...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-hero-bg text-center p-4">
      ...
      <div>
        <h1 className='text-white font-semibold uppercase tracking-widest mb-8 text-3xl'>{t('homePage.title')}</h1>
        <p className='text-gray-300 max-w-2xl italic text-2xl'>{t('homePage.subtitle')}</p>
      </div>
    </div>
  );
};
